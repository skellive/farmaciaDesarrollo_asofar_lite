...
public class Ingresar_Proveedor_Nota extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lblAgregarImagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/iconos/agregar.png"))); // NOI18N
        lblAgregarImagen.setText("AGREGAR IMAGEN");
        lblAgregarImagen.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        telefono.setFont(new java.awt.Font("Ubuntu", 1, 10)); // NOI18N
        telefono.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(50, 99, 50)));
        telefono.setPreferredSize(new java.awt.Dimension(6, 28));
        ...
        correo.setFont(new java.awt.Font("Ubuntu", 1, 10)); // NOI18N
        correo.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(50, 99, 50)));
        correo.setPreferredSize(new java.awt.Dimension(6, 28));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(118, 118, 118)
                        .addComponent(telefono, javax.swing.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)))
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(cbx1, javax.swing.GroupLayout.PREFERRED_SIZE, 18, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(cbx2, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//            System.out.println(lista.get(0).getTcd() + " " + lista.get(0).getTipos());
    ...
    private void lblGuardarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblGuardarMouseClicked
       if(telefono.getText().isEmpty() || correo.getText().isEmpty()){
          
           JOptionPane.showMessageDialog(this, "Completar todos los datos solicitados");
            ...
            Consulta_proveedor_Nota mp = new Consulta_proveedor_Nota(new javax.swing.JFrame(),true);
               setVisible(false);
              mp.setVisible(true);
    ...
    private void telefonoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_telefonoKeyTyped
        ...
        char car = evt.getKeyChar();
        //System.out.println(car);
        if (telefono.getText().length() == 9 /*|| nuevo1.getText().length() == 12*/) {
            // evt.consume();
            Habilitar(true);
            //System.out.println(cedula.getText().length());
        } else {
