 ...
 * @author alumno
 */
public class Mantenimiento_Precio extends javax.swing.JDialog {
    ...
    public Mantenimiento_Precio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    }

    public Mantenimiento_Precio(java.awt.Frame parent, boolean modal, Long id_pro1, String producto1) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        ...
        listaPrecios = llamar.listarPrecioCompra("SELECT id_precio,`id_producto`,`precio_base`,`precio_compra`, `compra_unidad`,`precio_venta`,`venta_unidad`, estado,porcentaje,`descuentoVenta`  FROM `precios` WHERE `id_producto`= " + id_pro);
        ...
        //HORA DEL SISTEMA
        Timer tiempo = new Timer(100, new Mantenimiento_Precio.horas());
        tiempo.start();
    }
...
//        objeto = devuelveObjeto(jtbPrecios.getValueAt(i, 0).toString(), listaPrecios);
        ...
        listaPrecios.clear();
        listaPrecios = llamar.listarPrecioCompra("SELECT id_precio,`id_producto`,`precio_base`,`precio_compra`, `precio_venta`,`venta_unidad`, estado,porcentaje,`descuentoVenta`  FROM `precios` WHERE `id_producto`= " + id_pro);
        t.visualizar(jtbPrecios, id_pro);
...
//        listaPrecios.clear();
            ...
            Logger.getLogger(Mantenimiento_Precio.class.getName()).log(Level.SEVERE, null, e);
        }
...
//            JasperReport reporte = (JasperReport) JRLoader.loadObject(dir);
            ...
            Logger.getLogger(Mantenimiento_Precio.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mantenimiento_Precio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Mantenimiento_Precio dialog = new Mantenimiento_Precio(new javax.swing.JFrame(), true);
