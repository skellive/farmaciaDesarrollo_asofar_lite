 ...
 * @author ineval
 */
public class Detalle_De_Compra extends javax.swing.JDialog {
    ...
    public Detalle_De_Compra(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public Detalle_De_Compra(java.awt.Frame parent, boolean modal, JoinListarNotaPedidosCabecera Obj) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
...
//        txtTotal.setText(Total_.setScale(2, BigDecimal.ROUND_HALF_UP).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Detalle_De_Compra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Detalle_De_Compra dialog = new Detalle_De_Compra(new javax.swing.JFrame(), true);
