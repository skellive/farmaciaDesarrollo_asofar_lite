 ...
 * @author ineval
 */
public class Detalle_Compra extends javax.swing.JDialog {
    ...
    public Detalle_Compra(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public Detalle_Compra(java.awt.Frame parent, boolean modal, JoinListarNotaPedidosCabecera Obj) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
...
//        txtTotal.setText(Total_.setScale(2, BigDecimal.ROUND_HALF_UP).toString());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Detalle_Compra dialog = new Detalle_Compra(new javax.swing.JFrame(), true);
