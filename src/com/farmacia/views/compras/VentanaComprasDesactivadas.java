...
public class VentanaComprasDesactivadas extends javax.swing.JDialog {
    ...
    public VentanaComprasDesactivadas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true); 
        initComponents();
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaComprasDesactivadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaComprasDesactivadas dialog = new VentanaComprasDesactivadas(new javax.swing.JFrame(), true);
