 ...
 * @author michaels
 */
public class Categoria_Nuevo extends javax.swing.JDialog {
    int x,y;
    CRUD crud = new CRUD();
     ...
     * @param modal
     */
    public Categoria_Nuevo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Categoria_Nuevo dialog = new Categoria_Nuevo(new javax.swing.JFrame(), true);
